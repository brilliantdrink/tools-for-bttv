...
import {CustomIcon, IconBaseProps, IconProps, IconTemplate, IconTypes} from 'solid-icons'
...
import {createTransferModalSignals, TransferModalType} from './transfer-modal'
...
type ModalType = GroupModalType | EmoteModalType | DeleteModalType | ApplyModalType | TransferModalType
...
type ModalSignals<E> =
  ...
  (E extends TransferModalType ? { transferModalSignals: ReturnType<typeof createTransferModalSignals> } : {})
...
const buttonTooltips = {
  ...
  [TransferModalType.Import]: 'Import emote associations',
  [TransferModalType.Export]: 'Export emote associations',
...
const ButtonIcons = {
  ...
  [TransferModalType.Import]: Import,
  [TransferModalType.Export]: Export,
  ...
  return (
    <li class={seasonalPanelStyle.groupItem}>
      ...
      <For each={props.buttons}>{type => {
        ...
        else if (type in TransferModalType) signals = 'transferModalSignals' in props ? props.transferModalSignals : null
...
function TFBCustomIcon(props: Omit<IconBaseProps, 'src'> & { src: PartialBy<IconBaseProps['src'], 'a'> }) {
  return CustomIcon({
    ...props,
    src: {
      ...props.src,
      a: {viewBox: '0 0 24 24', fill: 'currentColor', ...props.src.a},
    }
  })
}

function CogPlay(props: IconProps) {
  return TFBCustomIcon({
    ...props,
    src: {
...
export function Transfer(props: IconProps) {
  return TFBCustomIcon({
    ...props,
    src: {
      c: '<path fill-opacity=".4" d="M0 3c0-.93 0-1.4.15-1.77A2 2 0 0 1 1.23.15C1.6 0 2.07 0 3 0c1.86 0 2.8 0 3.53.3A4 4 0 0 1 8.7 2.47C9 3.2 9 4.14 9 6v12c0 1.86 0 2.8-.3 3.53a4 4 0 0 1-2.17 2.17C5.8 24 4.86 24 3 24c-.93 0-1.4 0-1.77-.15a2 2 0 0 1-1.08-1.08C0 22.4 0 21.93 0 21zM15 6c0-1.86 0-2.8.3-3.53A4 4 0 0 1 17.47.3C18.2 0 19.14 0 21 0c.93 0 1.4 0 1.77.15a2 2 0 0 1 1.08 1.08C24 1.6 24 2.07 24 3v18c0 .93 0 1.4-.15 1.77a2 2 0 0 1-1.08 1.08c-.37.15-.84.15-1.77.15-1.86 0-2.8 0-3.53-.3a4 4 0 0 1-2.17-2.17C15 20.8 15 19.86 15 18z"/><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="m14 7 5 5-5 5M5 12h14"/>'
    }
  })
}
...
export function Export(props: IconProps) {
  return TFBCustomIcon({
    ...props,
    src: {
      c: '<path fill-opacity=".4" d="M1 6.5c0-2.33 0-3.5.47-4.39A4 4 0 0 1 3.11.47C4 0 5.17 0 7.5 0s3.5 0 4.39.47a4 4 0 0 1 1.64 1.64C14 3 14 4.17 14 6.5v11c0 2.33 0 3.5-.47 4.39a4 4 0 0 1-1.64 1.64C11 24 9.83 24 7.5 24s-3.5 0-4.39-.47a4 4 0 0 1-1.64-1.64C1 21 1 19.83 1 17.5z"/><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M7 12h14m-4-4s3 2 4 4c-1 2-4 4-4 4"/>'
    }
  })
}
...
export function Import(props: IconProps) {
  return TFBCustomIcon({
    ...props,
    src: {
      c: '<path fill-opacity=".4" d="M9 6.5c0-2.33 0-3.5.47-4.39A4 4 0 0 1 11.11.47C12 0 13.17 0 15.5 0s3.5 0 4.39.47a4 4 0 0 1 1.64 1.64C22 3 22 4.17 22 6.5v11c0 2.33 0 3.5-.47 4.39a4 4 0 0 1-1.64 1.64C19 24 17.83 24 15.5 24s-3.5 0-4.39-.47a4 4 0 0 1-1.64-1.64C9 21 9 19.83 9 17.5z"/><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M3 12h14m-4-4s3 2 4 4c-1 2-4 4-4 4"/>'
    }
  })
}
